...
import com.vistar.streamcinema.service.DefaultVideoService;
import com.vistar.streamcinema.service.VideoService;
...
public class VideoController {
    ...
    public ResponseEntity<byte[]> readChunk(
        ...
        return ResponseEntity.status(HttpStatus.PARTIAL_CONTENT)
                ...
                .header(ACCEPT_RANGES, HttpHeaders.ACCEPT_RANGES)
